    ...
    <div className="p-8">
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-6">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Ritual Topics</h1>
            <p className="text-gray-500 mt-1">Manage ritual packs and daily practices</p>
          </div>
              ...
              <div key={category.id}>
                ...
                <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                  {categoryTopics.map(topic => (
                    <div key={topic.id} className="bg-white rounded-lg border border-gray-200 hover:border-ocean-300 transition-colors p-5">
